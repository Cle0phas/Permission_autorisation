        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-2 text-gray-900 h-18 flex">
                    <div class="flex-grow">DELETE ROLE TO USER</div>
                ...
                <div class="flex items-center h-25 p-2 border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.edited2',$cur_user->id    ) }}" method="POST" class="w-full">
                        @csrf
                        ...
                        <input type="hidden" name="methode" value="delete">
                            ...
                            <div class="justify-end items-center ml-6">               
                                <input type="submit" value="Validated" class="shadow appearance-none  border-none rounded w-full py-2 px-3 mr-6 text-gray-700  focus:outline-none focus:shadow-outline bg-red-400">
                            </div>
                        </div>
                    </form>
