        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-2 text-gray-900 h-18 flex">
                    <div class="flex-grow">ASSIGN PERMISSION</div>
                    <div class="justify-end"> <a href="{{route('admin.assignPermissions.index')  }}" class="bg-gray-300 p-2 rounded-md">Index</a> </div>
                </div>
                <hr>
                ...
                <div class="flex items-center h-25 p-2 border-b border-gray-200">
                    <form action="{{ route('admin.assignPermissions.store') }}" method="POST" class="w-full">
                        @csrf
                        <div class="flex w-full">
                            ...
                            <div class="flex-grow">
                                <select class="shadow appearance-none  border-none rounded w-full py-2 px-3 mr-6 text-gray-700  focus:outline-none focus:shadow-outline" name="permission" id="">                           
