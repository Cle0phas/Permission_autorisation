        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-2 text-gray-900 h-18 flex">
                    <div class="flex-grow">ASSIGN ROLE</div>
                    <div class="justify-end"> <a href="{{route('admin.assignRoles.index')  }}" class="bg-gray-300 p-2 rounded-md">Role Index</a> </div>
                </div>
                <hr>
                ...
                <div class="flex items-center h-25 p-2 border-b border-gray-200">
                    <form action="{{ route('admin.assignRoles.store') }}" method="POST" class="w-full">
                        @csrf
